...
public class Solution
{
    ...
    static class Orca   extends OceanAnimal
    {
        ...
        {
            return new Orca();  //To change body of implemented methods use File | Settings | File Templates.
        }
    }
    ...
    static class Whale extends OceanAnimal
    {
        ...
        Swimable getCurrentAnimal()
        {
            return new Whale();  //To change body of implemented methods use File | Settings | File Templates.
        }
    }
