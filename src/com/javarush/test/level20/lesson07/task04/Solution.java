...
public class Solution  implements Serializable{
    ...
    {
        FileInputStream finputStream = new FileInputStream("C:/rus/data.txt");
        FileOutputStream foutputStream = new FileOutputStream("C:/rus/data.txt");
        ObjectOutputStream  outputStream = new ObjectOutputStream(foutputStream);
        Solution savedObject = new Solution(54);
        try
        {
            if (savedObject != null)
            {
